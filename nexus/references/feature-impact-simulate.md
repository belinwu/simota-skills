...
- `nexus/references/apex-recipe.md` — full discovery-to-ship; this recipe is the pre-design preparation
- `nexus/references/growth-acceptance-recipe.md` — Phase 0 Pre-Design lifecycle gate
