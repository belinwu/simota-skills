...
| DAILY_IDEA | Dawn | +Forge (prototype), +Builder (production), +Zine (article). Trigger: "今日のアイデア", "毎朝のアイデア", "週末ハック", "副業プロジェクト案", "コーディングエージェントに渡せる題材". Don't confuse with Spark (existing-product feature proposals) |
