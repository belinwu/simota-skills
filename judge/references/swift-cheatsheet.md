...
- [`builder/references/swift-best-practices.md`](../../builder/references/swift-best-practices.md) — Swift API Design Guidelines, error handling, concurrency, value-type discipline
- [`builder/references/swift-anti-patterns.md`](../../builder/references/swift-anti-patterns.md) — force-unwrap, retain cycle, ARC, concurrency pitfalls
- [`builder/references/swift-language-spec.md`](../../builder/references/swift-language-spec.md) — Swift 6 strict concurrency, isolation regions, `Sendable`, ownership
...
1. **`try!` / `as!` / `!` (force-unwrap) in non-test code: justified?**
   ...
   - See [anti-patterns §1](../../builder/references/swift-anti-patterns.md).
...
2. **`@unchecked Sendable`: lock held? immutable witness?**
   ...
   - See [best-practices §7](../../builder/references/swift-best-practices.md) and [language-spec §4 — Sendable](../../builder/references/swift-language-spec.md).
...
4. **`Continuation` resume-once invariant**
   ...
   - See [anti-patterns §4](../../builder/references/swift-anti-patterns.md).
...
6. **Actor reentrancy: state read-after-`await` assumes no change**
   ...
   - See [language-spec §4.3 — actor reentrancy](../../builder/references/swift-language-spec.md).
...
9. **Missing `[weak self]` / `[unowned self]` capture lists in closures**
   ...
   - See [anti-patterns §2](../../builder/references/swift-anti-patterns.md).
...
The full Swift API Design Guidelines reference is in [`swift-best-practices.md §1`](../../builder/references/swift-best-practices.md). For a PR review, prioritize:
...
**Grounding step (mandatory)**: every Swift review finding must cite a SwiftLint rule, an API guidelines section, a Swift Evolution proposal, or one of the `builder/references/swift-*.md` rows. Free-text "this looks wrong" is rejected by Judge's grounding filter.
...
- Source of truth for all underlying knowledge:
  - [`builder/references/swift-best-practices.md`](../../builder/references/swift-best-practices.md) (API guidelines, error handling, concurrency, frameworks)
  - [`builder/references/swift-anti-patterns.md`](../../builder/references/swift-anti-patterns.md) (force-unwrap, retain cycles, ARC, concurrency pitfalls)
  - [`builder/references/swift-language-spec.md`](../../builder/references/swift-language-spec.md) (Swift 6 strict concurrency, Sendable, isolation, ownership)
