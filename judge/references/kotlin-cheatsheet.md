...
- [`builder/references/kotlin-best-practices.md`](../../builder/references/kotlin-best-practices.md) — Kotlin Style Guide, coroutines, Flow patterns, JVM interop
- [`builder/references/kotlin-anti-patterns.md`](../../builder/references/kotlin-anti-patterns.md) — `!!`, `runBlocking`, GlobalScope, leaks, dispatcher misuse
...
1. **`!!` force-unwrap: justified?**
   ...
   - See [anti-patterns §1](../../builder/references/kotlin-anti-patterns.md).
...
2. **`runBlocking { }` outside `main` / tests**
   ...
   - See [anti-patterns §3](../../builder/references/kotlin-anti-patterns.md).
...
5. **`async { ... }.await()` with exception swallow**
   ...
   - See [best-practices §5](../../builder/references/kotlin-best-practices.md).
...
7. **`runCatching { }` over typed Result without rethrow**
   ...
   - See [anti-patterns §5](../../builder/references/kotlin-anti-patterns.md).
...
The full Kotlin Style Guide reference is in [`kotlin-best-practices.md §1`](../../builder/references/kotlin-best-practices.md). For PR review, prioritize:
...
**Grounding step (mandatory)**: every Kotlin review finding must cite a detekt rule, ktlint rule, a Kotlin Style Guide section, a Kotlin Improvement Proposal (KEEP), or one of the `builder/references/kotlin-*.md` rows. Free-text "this looks wrong" is rejected by Judge's grounding filter.
...
- Source of truth for all underlying knowledge:
  - [`builder/references/kotlin-best-practices.md`](../../builder/references/kotlin-best-practices.md) (Style Guide, coroutines, Flow, JVM interop)
  - [`builder/references/kotlin-anti-patterns.md`](../../builder/references/kotlin-anti-patterns.md) (`!!`, runBlocking, GlobalScope, leaks)
  - [`builder/references/kotlin-language-spec.md`](../../builder/references/kotlin-language-spec.md) (Kotlin 2.x, K2, KMP, K/Native)
