...
- `spark/references/tri-engine-proposal.md` — canonical Pattern D implementation (mirror this structure)
- `plea/references/tri-engine-demand.md` — Pattern D with calibration (Riff does NOT calibrate but the dialogue-integration pattern is similar)
- `riff/references/patterns.md` — mode definitions and transition signals (referenced when interpreting which mode `multi` should default to)
- `riff/references/examples.md` — Riff dialogue tone; multi output cards inherit this voice
