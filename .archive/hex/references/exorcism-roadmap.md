...
- **AI-assisted refactor (2026)**: GitHub Copilot's coding agent (cloud-based, assigns issues → produces tested PRs), Cursor, and Claude Code are now viable for multi-file refactors. GitHub Copilot's agentic mode reduces time-to-merge for debt burn-down from weeks to hours on well-scoped issues. Pair AI execution with one of the patterns above; do not skip the pattern. Sources: <https://docs.github.com/en/copilot/tutorials/reduce-technical-debt>, <https://github.blog/ai-and-ml/github-copilot/how-the-github-billing-team-uses-the-coding-agent-in-github-copilot-to-continuously-burn-down-technical-debt/>.

AI-generated code introduces its own debt vectors: Atlassian State of DevEx 2025 found 99% of developers report time savings from AI tools, but organizational friction (fragmented workflows, context switching) still costs 10+ hours/week for half of teams. DORA 2025 found that AI amplifies existing team problems rather than resolving them. Treat AI-driven refactor items as `medium` risk minimum and require human review before merge. Sources: <https://www.atlassian.com/teams/software-development/state-of-developer-experience-2025>, <https://dora.dev/research/2025/dora-report/>.
