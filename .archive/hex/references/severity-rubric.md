...
- **CodeScene CodeHealth™**: 1–10 scale where 10 is healthy; monitors 25+ code smells and flags AI-generated code in real time via the CodeHealth™ MCP Server (launched 2025). Research notes a ~60% defect-risk lift when AI generates code into already-unhealthy files; 75% of tech leaders projected to be impacted by AI-accelerated technical debt by 2026. Use as cross-reference when justifying T3+. Sources: <https://codescene.com/product/code-health>, <https://codescene.com/product/code-health-mcp>.
...
- **SonarQube Maintainability Rating**: A = remediation cost ≤ 5% of development cost, B ≤ 10%, C ≤ 20%, D ≤ 50%, E > 50%. Consistent across SonarQube Server 10.x and 11.x. Hex tier does not replace this rating; it is a complementary anthropomorphization layer. Source: <https://docs.sonarsource.com/sonarqube-server/user-guide/code-metrics/metrics-definition>.
- **McKinsey tech debt baseline**: Tech debt accounts for ~40% of IT balance sheets; 10–20% of new-product budget is diverted to debt remediation. Actively managing tech debt can free engineers to spend up to 50% more time on value-generating work. Sources: <https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/tech-debt-reclaiming-tech-equity>, <https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/breaking-technical-debts-vicious-cycle-to-modernize-your-business>.
- **DORA 2025 Report (State of AI-Assisted Software Development)**: Surveyed ~5,000 technology professionals; found that large technical debt blocks progress and amplifies team dysfunction when combined with AI tooling — "AI doesn't fix a team; it amplifies what's already there." High technical debt correlates with higher burnout and lower delivery performance. Use DORA cluster "Foundational challenges" as a T4–T5 stakeholder framing. Source: <https://dora.dev/research/2025/dora-report/>.
- **Atlassian State of DevEx 2025**: 50% of developers lose >10 hours/week to organizational inefficiencies; organizations with 500 developers estimated to lose up to $7.9M annually. Ties productivity drag to fragmented workflows and cross-team friction — complementary to per-codebase debt scoring when framing T3+ business impact. Source: <https://www.atlassian.com/teams/software-development/state-of-developer-experience-2025>.
