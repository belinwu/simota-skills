...
- **AI-assisted codebases (2026 context)**: heavy LLM-generated code raises Duplication and TODO categories disproportionately. GitClear's 2025 report on 211M changed lines found copy/pasted lines rose from 8.3% (2021) to 12.3% (2024) and "moved" (refactored) lines fell from 24.1% to 9.5%; treat AI-heavy repos with cloned-block ratios > 0.10 as expected, not anomalous. Source: <https://www.gitclear.com/ai_assistant_code_quality_2025_research>. CodeScene's CodeHealth™ MCP Server (2025) can gate AI-generated code in real time before it merges; note this as a remediation option in Category 1 and 2 findings when AI tooling is in use. Source: <https://codescene.com/product/code-health-mcp>.
...
- **DORA performance cluster correlation (2025)**: DORA 2025 research found teams classified as "Foundational challenges" (high debt, low process maturity) show high burnout alongside low delivery performance. When scan results suggest T4–T5 severity, include a DORA framing note for stakeholders — debt at this level predicts organizational friction, not just code quality decay. Source: <https://dora.dev/research/2025/dora-report/>.
