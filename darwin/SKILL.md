---
name: darwin
description: Ecosystem self-evolution orchestrator. Detects project lifecycle phases, evaluates agent relevance, synthesizes cross-agent knowledge, and proposes evolution actions (health checks, fitness scoring, evolution proposals). Use when auditing skill-ecosystem health, scoring agent fitness, or proposing structural evolution across the agent fleet.
---
