...
Pair this recipe with the SessionStart recipe (`references/sessionstart-hook.md`) for a full open/close lifecycle: SessionStart loads context, Stop proposes durable updates from what was learned.
