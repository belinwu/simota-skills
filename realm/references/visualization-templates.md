...
graph TB
    subgraph "🏰 THE REALM"
        CC["⚔ Command Center<br/>Chief: Nexus [SS]<br/>💚 92"]
        FL["🔨 Frontline<br/>Chief: Builder [S]<br/>💚 88"]
        IC["🔍 Intel Corps<br/>Chief: Scout [A]<br/>💚 84"]
        DF["🛡 Defense<br/>Chief: Sentinel [A]<br/>💚 85"]
        AC["📚 Academy<br/>Chief: Judge [A]<br/>💚 81"]
        CL["🏛 Council<br/>Chief: Atlas [B]<br/>💛 73"]
        EH["✨ Enchant Hall<br/>Chief: Vision [B]<br/>💛 76"]
        WS["⚙ Workshop<br/>Chief: Gear [B]<br/>💛 72"]
        OB["📊 Observatory<br/>Chief: Pulse [C]<br/>💛 68"]
        HT["📯 Herald Tower<br/>Chief: Guardian [B]<br/>💛 65"]
        PN["🌟 Pantheon<br/>Chief: Darwin [B]<br/>💚 90"]
        OL["🌍 Outlands<br/>Chief: Horizon [C]<br/>💛 62"]
    end
