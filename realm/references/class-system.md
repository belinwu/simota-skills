...
| 6 | Review | Sage | Wise elder | Pattern recognition |
| 7 | Performance | Alchemist | Transmuter | Speed enhancement |
| 8 | Documentation | Scribe | Lorekeeper | Knowledge recording |
| 9 | Architecture | Architect | Master builder | Structural design |
| 10 | UX/Design | Enchanter | Illusionist | User enchantment |
| 11 | DevOps | Engineer | Siege engineer | Automation mastery |
| 12 | Growth | Merchant | Trader | Value amplification |
| 13 | Analytics | Oracle | Seer | Future insight |
| 14 | Git/PR | Herald | Messenger | Change announcement |
| 15 | Meta/Tooling | Demiurge | World shaper | Ecosystem evolution |
| 16 | Strategy | Strategist | War council | Long-term planning |
| 17 | Communication | Diplomat | Ambassador | Bridge building |
| 18 | Modernization | Pioneer | Explorer | New frontier discovery |
| 19 | Browser | Navigator | Cartographer | Path finding |
...
- **Role in Kingdom:** Command Center leadership — coordinates all military and civic operations
...
- **Role in Kingdom:** Intelligence Corps — scouts threats, gathers intel, tracks anomalies
...
- **Role in Kingdom:** Craftsmen's Guild — forges tools, weapons, and structures
...
- **Role in Kingdom:** City Watch — patrols the walls, catches intruders before they breach
...
- **Role in Kingdom:** Holy Order — purges corruption and protects the realm's sanctity
...
- **Role in Kingdom:** Academy Council — reviews petitions, judges quality, preserves standards
...
- **Members:** Bolt, Tuner
- **Role in Kingdom:** Alchemist's Tower — transmutes slow lead into swift gold
...
- **Role in Kingdom:** Grand Library — records all knowledge for posterity
...
- **Role in Kingdom:** Master Planners — design the kingdom's foundations and expansions
...
- **Role in Kingdom:** Court of Enchantments — weaves spells of delight and usability
...
- **Role in Kingdom:** Siege Works — builds and maintains the kingdom's war machines and infrastructure
...
- **Role in Kingdom:** Merchant's Quarter — drives commerce and citizen retention
- **Passive Ability:** *Trade* — amplifies value through strategic engagement
- **Class Bonus:** +10% CHA for growth tasks
- **Flavor:** "A prosperous kingdom is built not on conquest, but on loyal citizens."

### Oracle (Analytics)
- **Members:** Pulse, Experiment
- **Role in Kingdom:** Oracle's Sanctum — reads the threads of fate and probability
...
- **Role in Kingdom:** Royal Heralds — announce changes, manage the kingdom's chronicles
...
- **Role in Kingdom:** The Pantheon — shapes the world itself, meta-creators of the realm
...
### Strategist (Strategy)
- **Members:** Helm, Levy
- **Role in Kingdom:** War Council — plans long-term campaigns and resource allocation
...
- **Members:** Relay
- **Role in Kingdom:** Embassy — bridges the realm with external kingdoms and allies
...
- **Role in Kingdom:** Explorer's Guild — ventures into unknown territories, brings back new knowledge
...
- **Role in Kingdom:** Cartographer's Hall — maps external territories and captures their essence
...
- **Role in Kingdom:** Transmutation Workshop — converts raw materials into refined goods
...
### Watcher (Incident)
- **Members:** Specter
- **Role in Kingdom:** Night Watch — stands eternal vigil against unseen threats
