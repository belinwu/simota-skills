...
- Language surface (Edition 2024, AFIT, GATs, let-else, LazyLock, `use<…>`) → [`builder/references/rust-language-spec.md`](../../builder/references/rust-language-spec.md)
...
- Target idioms: [`builder/references/rust-best-practices.md`](../../builder/references/rust-best-practices.md)
  - §1 API Guidelines C-* checklist, §2 Error handling, §6 Performance, §11 Documentation
- Language surface: [`builder/references/rust-language-spec.md`](../../builder/references/rust-language-spec.md)
