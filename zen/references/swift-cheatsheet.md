...
- Language surface (typed throws, `@Observable`, region isolation, `~Copyable`, macros) → [`builder/references/swift-language-spec.md`](../../builder/references/swift-language-spec.md)
...
Follow Apple's Swift API Design Guidelines [`builder/references/swift-best-practices.md`](../../builder/references/swift-best-practices.md) §1 exactly. Rename targets that violate any of these:
...
- Bad-pattern catalog: [`builder/references/swift-anti-patterns.md`](../../builder/references/swift-anti-patterns.md)
- Target idioms: [`builder/references/swift-best-practices.md`](../../builder/references/swift-best-practices.md)
  - §1 API Design Guidelines, §2 Concurrency, §7 Testing, §8 Performance
- Language surface: [`builder/references/swift-language-spec.md`](../../builder/references/swift-language-spec.md)
