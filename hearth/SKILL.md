...
- editor_configuration: neovim 0.11+ builtin LSP config and auto-completion, vim/Zed plugin layout, treesitter, and DAP setup
...
- editor configuration (neovim 0.11+, vim, Zed) with plugins, builtin LSP config, and auto-completion
...
| Editor | `neovim 0.11+`, `vim`, `Zed` | `neovim 0.11+` | Builtin LSP config (`~/.config/nvim/lsp/*.lua`) and opt-in auto-completion since 0.11; lazy.nvim + Mason + Tree-sitter; LazyVim requires 0.11.2+ |
