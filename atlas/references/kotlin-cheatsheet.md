...
- Project structure & Gradle → [`builder/references/kotlin-best-practices.md`](../../builder/references/kotlin-best-practices.md) §5
- Architecture patterns (Clean / MVI / repository) → [`builder/references/kotlin-best-practices.md`](../../builder/references/kotlin-best-practices.md) §11
- API design pitfalls → [`builder/references/kotlin-anti-patterns.md`](../../builder/references/kotlin-anti-patterns.md) §17
- Class hierarchy pitfalls → [`builder/references/kotlin-anti-patterns.md`](../../builder/references/kotlin-anti-patterns.md) §4
...
For full anti-pattern catalog: [`builder/references/kotlin-anti-patterns.md`](../../builder/references/kotlin-anti-patterns.md) §4 (Class hierarchy), §13 (Gradle/KSP), §17 (API Design).
...
- Project structure & Gradle: [`builder/references/kotlin-best-practices.md`](../../builder/references/kotlin-best-practices.md) §5
- Architecture patterns: [`builder/references/kotlin-best-practices.md`](../../builder/references/kotlin-best-practices.md) §11
- Multiplatform best practices: [`builder/references/kotlin-best-practices.md`](../../builder/references/kotlin-best-practices.md) §4
- Class hierarchy pitfalls: [`builder/references/kotlin-anti-patterns.md`](../../builder/references/kotlin-anti-patterns.md) §4
- API design pitfalls: [`builder/references/kotlin-anti-patterns.md`](../../builder/references/kotlin-anti-patterns.md) §17
- KMP & K2 specifics: [`builder/references/kotlin-language-spec.md`](../../builder/references/kotlin-language-spec.md) §5, §13
