...
> - Constructive crypto / TLS stack: [`builder/references/rust-best-practices.md` §7 Security practices](../../builder/references/rust-best-practices.md#7-security-practices) (§7.3 secrecy+zeroize, §7.4 subtle, §7.5 rustls, §7.6 crypto crate matrix)
> - Security pitfalls including constant-time compare, secret logging, CSPRNG misuse: [`builder/references/rust-anti-patterns.md` §12 Security Pitfalls](../../builder/references/rust-anti-patterns.md#12-security-pitfalls)
> - Sibling reviewer (SAST-level): [`sentinel/references/rust-cheatsheet.md`](../../sentinel/references/rust-cheatsheet.md)
...
Reference: [`builder/references/rust-best-practices.md` §7.5](../../builder/references/rust-best-practices.md#7-security-practices). Migration: `tokio-tls` / `hyper-tls` → `tokio-rustls` / `hyper-rustls`.
...
Reference: [`builder/references/rust-best-practices.md` §7.6](../../builder/references/rust-best-practices.md#7-security-practices).
...
Reference: [`builder/references/rust-best-practices.md` §7.4](../../builder/references/rust-best-practices.md#7-security-practices), [anti-patterns §12.11](../../builder/references/rust-anti-patterns.md#12-security-pitfalls).
...
Reference: [`builder/references/rust-best-practices.md` §7.3](../../builder/references/rust-best-practices.md#7-security-practices), [anti-patterns §12.2, §12.3, §12.18, §12.20](../../builder/references/rust-anti-patterns.md#12-security-pitfalls).
...
Reference: [`builder/references/rust-best-practices.md` §7.6](../../builder/references/rust-best-practices.md#7-security-practices) for the crate matrix. Existing skill reference: [`crypt/references/password-hashing.md`](./password-hashing.md) for the deep dive.
...
Existing skill reference: [`crypt/references/kms-integration.md`](./kms-integration.md) for the deep dive.
...
Reference: [anti-patterns §12.12](../../builder/references/rust-anti-patterns.md#12-security-pitfalls).
...
Existing skill reference: [`crypt/references/post-quantum-migration.md`](./post-quantum-migration.md) for the deep dive.
...
Reference: [anti-patterns §12.6](../../builder/references/rust-anti-patterns.md#12-security-pitfalls) on deserialization (JWT claim payload is JSON — same body-size and budget rules apply).
...
| **`tracing::info!("decrypted: {plaintext:?}")`** | Logs plaintext at INFO level. Audit log shippers, SaaS observability vendors. See [anti-patterns §12.2](../../builder/references/rust-anti-patterns.md#12-security-pitfalls). |
