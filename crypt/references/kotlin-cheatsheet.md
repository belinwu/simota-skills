...
> - Production library matrix incl. crypto (§10.7), HTTP (§10.1), serialization (§10.3), logging (§10.5): [`builder/references/kotlin-best-practices.md` §10 Production Library Matrix](../../builder/references/kotlin-best-practices.md#10-production-library-matrix-2026-baseline)
...
Reference: [`builder/references/kotlin-best-practices.md` §10.7 Crypto](../../builder/references/kotlin-best-practices.md#107-crypto).
