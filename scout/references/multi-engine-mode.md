...
Detailed reference for the `multi` Recipe. Top-level mechanics summary lives in `SKILL.md §Multi-Engine Mode`; full tri-engine algorithm in `references/tri-engine-investigate.md`; cross-skill protocol in `_common/MULTI_ENGINE_RECIPE.md`.
