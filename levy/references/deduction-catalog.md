...
| # | 控除名 | 控除額 | 主な要件 |
|---|--------|--------|---------|
| 1 | **基礎控除** | 最大48万円 | 合計所得2,500万円以下（2,400万円超で逓減） |
...
| 14 | **寄附金控除** | 寄附金−2,000円 | ふるさと納税・認定NPO等（所得の40%上限） |
...
> **注意**: 控除額・要件は税制改正により変更される可能性があります。対象年度の最新情報を国税庁サイトで確認してください。
