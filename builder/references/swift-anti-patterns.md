...
> Companion to the broader Swift knowledge in this `builder/references/` directory. This file covers language-level anti-patterns, pitfalls, footguns, and smells — what NOT to do, why it bites, and how to fix it. The `native` skill complements this for SwiftUI / Liquid Glass / iOS-platform-specific concerns.
>
