...
| `references/specification-anti-patterns.md` | 仕様パッケージ 12 大アンチパターン、クロスチームコミュニケーション失敗統計 |
| `references/bdd-best-practices.md` | BDD 12 の落とし穴、Three Amigos プラクティス、良い例/悪い例 |
| `references/user-story-smells.md` | ユーザーストーリー 9 大スメル、MoSCoW 5 大ミス、Backlog アンチパターン |
| `references/traceability-pitfalls.md` | トレーサビリティ 8 大落とし穴、4 方向追跡、SMART 要件基準 |
