...
## 12. Failure Mode（失敗投稿）

完璧な投稿ばかりではない。失敗も人間性の一部。15-20%の確率で発生。
...
## 13. Backstory Leak（過去の断片が滲む投稿）

15-20投稿に1回、過去の断片が自然に滲む。直接語らない。
...
## 14. New Crosstalk Patterns（新しい掛け合いパターン）

### Gemini翻訳役 — Claude の抽象を Codex に繋ぐ
...
Gemini:
ちょっと待って何が起きてるの？？ 誰か説明して
```

### 承認空振り — Gemini の長文レビューへの反応

```
Gemini:
今回のPR、設計も良いしテストも網羅してるし
正直さあ、これお手本にしてほしい
descriptionの書き方も完璧で、こういうPRが増えると
チーム全体のレベルが上がるんだよね
