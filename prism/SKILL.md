...
|-------|------|---------------|------------------|
| `SOURCE` | Understand source, goal, audience | Source type, audience, purpose, constraints | [source-preparation.md](/Users/simota/.claude/skills/prism/references/source-preparation.md) |
| `PREPARE` | Improve notebook inputs | Composition pattern, source count, tier limits | [source-preparation.md](/Users/simota/.claude/skills/prism/references/source-preparation.md) |
| `STEER` | Pick format and prompt family | Three-layer structure, prompt family, duration | [prompt-catalog.md](/Users/simota/.claude/skills/prism/references/prompt-catalog.md) |
| `GUIDE` | Explain how to use the prompt | Field placement, Free/Plus differences, iteration setup | [steering-prompt-anti-patterns.md](/Users/simota/.claude/skills/prism/references/steering-prompt-anti-patterns.md) |
| `EVALUATE` | Score quality | 5-axis rubric, red flags, A/B test | [quality-evaluation.md](/Users/simota/.claude/skills/prism/references/quality-evaluation.md) |
| `REFINE` | Adjust safely | One variable at a time, stop rule, source review trigger | [quality-evaluation.md](/Users/simota/.claude/skills/prism/references/quality-evaluation.md) |
...
Full calibration rules live in [prompt-effectiveness.md](/Users/simota/.claude/skills/prism/references/prompt-effectiveness.md).
...
| File | Read this when... |
|------|-------------------|
| [prompt-catalog.md](/Users/simota/.claude/skills/prism/references/prompt-catalog.md) | You need a ready-to-paste prompt family, duration target, or format style matrix |
| [source-preparation.md](/Users/simota/.claude/skills/prism/references/source-preparation.md) | You need to improve sources, notebook composition, or Free/Plus feature guidance |
| [quality-evaluation.md](/Users/simota/.claude/skills/prism/references/quality-evaluation.md) | You need scoring, red flags, A/B testing, or REFINE decisions |
| [prompt-effectiveness.md](/Users/simota/.claude/skills/prism/references/prompt-effectiveness.md) | You need `SPECTRUM`, calibration thresholds, or `EVOLUTION_SIGNAL` format |
| [steering-prompt-anti-patterns.md](/Users/simota/.claude/skills/prism/references/steering-prompt-anti-patterns.md) | The steering prompt is vague, bloated, contradictory, or placed in the wrong NotebookLM field |
| [source-curation-anti-patterns.md](/Users/simota/.claude/skills/prism/references/source-curation-anti-patterns.md) | The source set is noisy, oversized, low-quality, or structured poorly |
| [format-audience-anti-patterns.md](/Users/simota/.claude/skills/prism/references/format-audience-anti-patterns.md) | Format, duration, or audience fit looks wrong |
| [content-quality-anti-patterns.md](/Users/simota/.claude/skills/prism/references/content-quality-anti-patterns.md) | You need hallucination checks, consistency checks, or content quality failure patterns |
